...
class Parser:
    ...
    def parse_grouped_expression(self) -> ast.Expression:
        ...
        return exp
    def parse_if_statement(self) -> ast.Expression: # Note: If is an expression in this model
        token = self.current_token
    ...
    def _register_prefix_fns(self):
        return {
            ...
            TokenType.STRING: self.parse_string_literal, TokenType.TRUE: self.parse_boolean,
            TokenType.FALSE: self.parse_boolean, TokenType.BANG: self.parse_prefix_expression,
