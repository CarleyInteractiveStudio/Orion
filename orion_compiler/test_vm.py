...
from orion_compiler.compiler import compile as compile_source
from orion_compiler.vm import VM, InterpretResult
from orion_compiler.disassembler import disassemble_chunk

def _orion_to_python_test_helper(value):
    from orion_compiler.objects import OrionList, OrionDict, OrionInstance
